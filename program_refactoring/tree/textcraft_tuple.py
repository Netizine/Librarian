...
from program_refactoring.codebank.test_case import TextCraftTestCase
...
class TextCraftTuple(Tuple):
    def __init__(
        self, nodes: Dict[int, Node], task: str = "textcraft", temp_dir: str = "temp"
    ):
...
"""
    ...
    def merge(
        ...
        prompt = textcraft_tuple_refactor_prompt.format(
    ...
    def test_programs(
        ...
        for idx, prog in new_programs.items():
            ...
            prog_dict = {
                ...
                if k in TextCraftNode.__init__.__code__.co_varnames
            }
            prog_dict["type"] = "pred"
